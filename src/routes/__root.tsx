...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Twogether — an operating system for two" },
      ...
      { name: "twitter:title", content: "Twogether — an operating system for two" },
      { name: "twitter:description", content: "A private, warm space for couples to share money, plans, wishlists, and memories." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/48c0ae9c-7ee7-4973-b252-98cc63a2844b/id-preview-b6888bad--0cc8872b-6622-4513-bd66-e399c4d974c1.lovable.app-1783449079893.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/48c0ae9c-7ee7-4973-b252-98cc63a2844b/id-preview-b6888bad--0cc8872b-6622-4513-bd66-e399c4d974c1.lovable.app-1783449079893.png" },
    ],
    links: [
